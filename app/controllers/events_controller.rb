class EventsController < ApplicationController
  ...
  private
    ...
    # Set the event_types array for proper editing of events
    def set_event_types
      @event_types = ['Practice','League Meet','League Championship','Qualifier','Championship','Super Regional','World Championship']
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def event_params
      params.require(:event).permit(:season_id, :name, :city, :state, :country, :start_date, :end_date, :event_type)
    end
end
