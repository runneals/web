...
RSpec.describe "team_division_informations/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit team_division_information form" do
    render

    assert_select "form[action=?][method=?]", team_division_information_path(@team_division_information), "post" do
